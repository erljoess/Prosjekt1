...
Time_data = cmd.convert_Time_data(Time_data)                        # Hentar inn data til Time_data[].
    ...
    #Vil finne høgaste og lågaste temperatur siste døgn:
...
for i in range((len(Time_warmest))*2-1): # Gjer klart til plotting
...
# Temperatur-plotta:
    ...
    ax1.plot(Time_temp_drop_tider, Time_temp_drop, color="violet", label='Temperature drop from max til min')
    # Formaterer x-aksen:
